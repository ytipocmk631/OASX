...
final Map<String, String> _us_global_game = {
  ...
  I18n.invitation_detect_interval_help:
      'Detect collaboration every 10 seconds by default',
  I18n.when_network_abnormal_help:
      'By default, it will wait for 10 seconds first',
  I18n.when_network_error_help: 'Restart the game',
  I18n.home_client_clear_help:
