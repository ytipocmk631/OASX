...
final Map<String, String> _cn_ui = {
  ...
  I18n.network_unknown_error: '网络未知错误',
  I18n.no_data: '暂无数据',
  ...
  I18n.confirm: '确定',
  I18n.new_name: '新名称',
  I18n.delete_confirm: '你确定要删除',
  I18n.name_cannot_empty: '名称不能为空',
  I18n.name_invalid: '名称非法',
  I18n.name_duplicate: '名称已存在',
  I18n.config_update_tip: '当前脚本正在运行，请停止后再修改',
...
控制方式是模拟人类的速度，也不是越快越好 使用(window_message)会偶尔出现失效的情况''',
  ...
  I18n.emulatorinfo_type_help: '''选择你使用的模拟器类型
            ''',
  I18n.emulatorinfo_name: '模拟器名称',
  I18n.emulatorinfo_name_help: '''示例: MuMuPlayer-12.0-0, 若不清楚请查阅文档
            ''',
  I18n.emulator_window_minimize: '启用模拟器窗口最小化',
  I18n.run_background_only: '启用模拟器仅后台运行',
...
final Map<String, String> _cn_invite_config = {
...
final Map<String, String> _cn_fallen_sun_config = {
  'fallen_sun_config': '日轮之陨',
};

final Map<String, String> _cn_eternity_sea_config = {
...
final Map<String, String> _cn_gold_youkai_config = {
  'gold_youkai': '金币妖怪',
};

final Map<String, String> _cn_nian_config = {
  'nian_config': '年兽配置',
};

final Map<String, String> _cn_talisman_config = {
  'talisman': '花合战',
  'level_reward': '选择礼盒',
  'harvest_soul': '启用收获御魂',
};

final Map<String, String> _cn_pets_config = {
  'pets_config': '小猫咪',
  'pets_happy': '其乐融融',
  'pets_feast': '饕餮大餐',
};

final Map<String, String> _cn_simple_tidy_config = {
  'simple_tidy': '简易御魂清理',
...
final Map<String, String> _cn_evo_zone_config = {
  'evo_zone_config': '觉醒副本',
  'kirin_type': '麒麟选择',
  'kirin_type_help': '',
};

final Map<String, String> _cn_goryou_config = {
  'goryou_config': '御灵之境',
  'goryou_class': '挑战类型',
  'goryou_class_help': '',
};
...
final Map<String, String> _cn_utilize_config = {
  ...
  'select_friend_list_help': '''由于该死的游戏制作水准，无论任何方式都不可以稳定的对结界卡进行排序，需要从头到尾遍历一遍。
...
final Map<String, String> _cn_true_orochi_config = {
...
final Map<String, String> _cn_shop_config = {
  'shop_config': '购买',
...
final Map<String, String> _cn_herotest_config = {
  'herotest': '英杰试炼',
  'HeroTest': '英杰试炼',
};
...
final Map<String, String> _cn_experience_youkai_config = {
...
final Map<String, String> _cn_demon_retreat_config = {
